...
- Edit Buku (admin)
  ![Edit Buku (admin)](docs/screenshots/Edit-Buku-Admin.png)
- Edit Buku berhasil
  ![Edit Buku berhasil](docs/screenshots/Edit-Buku-berhasil.png)
- Edit Buku gagal (ISBN sudah ada)
  ![Edit Buku gagal (ISBN sudah ada)](docs/screenshots/Edit-Buku-ErrorISBNSama.png)
- Buku berhasil dihapus
  ![Buku berhasil dihapus](docs/screenshots/Buku-Berhasil-Dihapus.png)
- Buku gagal dihapus (masih dipinjam)
  ![Buku gagal dihapus (masih dipinjam)](docs/screenshots/Buku-TidakBerhasil-Dihapus.png)
- Catat Peminjaman
  ![Catat Peminjaman](docs/screenshots/Catat-Pinjaman.png)
- Catat Peminjaman berhasil
  ![Catat Peminjaman berhasil](docs/screenshots/Catat-Pinjaman-Berhasil.png)
- Daftar Peminjaman (setelah dicatat)
...
- Daftar Peminjaman (aktif)
  ![Daftar Peminjaman (aktif)](docs/screenshots/Daftar-Peminjaman-Aktif.png)
- Daftar Peminjaman (jatuh tempo)
  ![Daftar Peminjaman (jatuh tempo)](docs/screenshots/Daftar-Peminjaman-JatuhTempo.png)
- Daftar Peminjaman (selesai)
  ![Daftar Peminjaman (selesai)](docs/screenshots/Daftar-Peminjaman-Selesai.png)
- Laporan Peminjaman
  ![Laporan Peminjaman](docs/screenshots/Laporan-Peminjaman.png)
- Home (member)
  ![Home (member)](docs/screenshots/Home-Member.png)
- Daftar Buku (member)
  ![Daftar Buku (member)](docs/screenshots/Daftar-Buku-Member.png)
- Pencarian Buku (member)
  ![Pencarian Buku (member)](docs/screenshots/Search-Buku-Member.png)
- Daftar Peminjaman (member)
  ![Daftar Peminjaman (member)](docs/screenshots/Daftar-Peminjaman-Member.png)
- Pencarian Peminjaman (member)
